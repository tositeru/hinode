...
namespace Hinode
{
    public interface IControllerSenderGroup
    {
        ...
        bool DoHasSenderKeyword(string keyword);
        System.Type GetSenderType(string keyword);
        bool ContainsSender(System.Type senderType);
        IControllerSenderInstance CreateInstance(Model target, ModelViewBinderInstanceMap instanceMap);
    }
        ...
        where InstanceType : IControllerSenderInstance, new()
    {
        ...
        public bool DoHasSenderKeyword(string keyword)
        ...
        public IControllerSenderInstance CreateInstance(Model target, ModelViewBinderInstanceMap instanceMap)
        {
