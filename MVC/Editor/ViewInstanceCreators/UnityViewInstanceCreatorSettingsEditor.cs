...
namespace Hinode.Editors.MVC.ViewInstanceCreatorSettings
{
    public class EditorCommon
    {
        ...
        [CustomEditor(typeof(UnityViewInstanceCreatorSettings))]
    ...
    class InstanceInfoCommon
    {
        ...
        public class EditorParam
        {
            ...
            UnityViewInstanceCreatorSettings.InstanceInfo Self { get; }
            ...
            {
                propDict = CreatePropDict(prop);
                Self = prop.GetSelf() as UnityViewInstanceCreatorSettings.InstanceInfo;
            ...
            public void OnInspectorGUI(GUIContent label = null)
            {
                ...
                using (var indent = new EditorGUI.IndentLevelScope(1))
                {
                    ...
                    switch ((UnityViewInstanceCreatorSettings.InfoType)propDict[PropType.Type].enumValueIndex)
                    {
                        case UnityViewInstanceCreatorSettings.InfoType.Asset:
                            DrawAsset();
                            break;
                        case UnityViewInstanceCreatorSettings.InfoType.Resources:
                            DrawResources();
                            break;
                        case UnityViewInstanceCreatorSettings.InfoType.AssetBundle:
                            DrawAssetBundle();
                            break;
                        default:
            ...
            {
                UnityViewInstanceCreatorSettings.InstanceInfo Info { get; set; }
                public System.Type CurrentInstanceType { get; }

                public ParamBinderTypePopup(UnityViewInstanceCreatorSettings.InstanceInfo info)
                {
                    Info = info;
